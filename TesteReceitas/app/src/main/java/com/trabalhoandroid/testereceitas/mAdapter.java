...
public class mAdapter extends RecyclerView.Adapter<ReceitasViewHolder>{

    private Context mContext;
    private List<DadosReceita> mReceitasList;

    public mAdapter(Context mContext, List<DadosReceita> mReceitasList) {
...
class ReceitasViewHolder extends RecyclerView.ViewHolder{
    ImageView imageView;
    TextView mTitulo, mIngredientes ,mDescricao;
    CardView mCardView;
